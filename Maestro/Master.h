...
enum {
  AM_BLINKTORADIO = 17,
  TIMER_PERIODO_COMPLETO = 1000*2,    // Tiempo total entre el comienzo de dos tramas consecutivas
  TIMER_PERIODO_TRAMA = 400*2,        // Tiempo desde el comienzo de una trama hasta el final de su TDMA
  TIMER_PERIODO_NODO = TIMER_PERIODO_TRAMA/(NUM_MAX_NODOS+1), // Tiempo que tiene cada nodo para transmitir en el TDMA 
